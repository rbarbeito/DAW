...
# -------------------------------------------
# [x] Calcular las ganancias totales. (Imaginamos un valor por habitacion)
# [x] Ganancias totales de la temporada
# [x] Desglose de ganancias por hoteles.
# [x] Todo lo anterior pero dependiendo la habitación y/o hotel y/o planta vale mas o menos dinero.
# [x] Saber que plantas son las más demandadas.
...
while menu != 0:
    ...
    if menu == 1:
        ...
        print()
        print("Ganancia en las habitaciones normales",
              acumulado[0][0]+acumulado[1][0]+acumulado[2][0])
        print("Ganancia en las habitaciones medium",
              acumulado[0][1]+acumulado[1][1]+acumulado[2][1])
        print("Ganancia en las habitaciones premium",
              acumulado[0][2]+acumulado[1][2]+acumulado[2][2])
